...
<div class="flex justify-center items-center my-10">
    <form action="" method="POST" class="bg-gray-100 p-10 rounded shadow">
        ...
        <button type="submit" name="register" class="w-full p-2 my-5 border-2 border-gray-300" >Register</button>
        <div class="my-5">
        <p class="text-center">Already have an account?
            <a href="login.php" class="text-blue-500">Login Now</a></p>
        </div>
    </form>
...
if(isset($_POST['register'])){
    ...
    if ($password == $cpassword){
        ...
        echo "<script>alert('password and confrim password don't match')</script>"; 
    }
}
?>
